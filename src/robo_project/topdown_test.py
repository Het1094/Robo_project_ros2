...
# --- TRANSLATE THE TILDE SYMBOL AND FIX 'resources' TYPO ---
SCENE = os.path.expanduser("~/robo_project_ws/src/environment/Denmark.glb")

ORIGINAL_MAP_PATH = os.path.expanduser("~/robo_project_ws/src/resources/topdown_grid_map.png")
INFLATED_MAP_PATH = os.path.expanduser("~/robo_project_ws/src/resources/topdown_inflated_grid_map.png")
DIFFERENCE_MAP_PATH = os.path.expanduser("~/robo_project_ws/src/resources/topdown_difference_map.png")

BINARY_GRID_PATH = os.path.expanduser("~/robo_project_ws/src/resources/binary_grid.npy")
INFLATED_BINARY_GRID_PATH = os.path.expanduser("~/robo_project_ws/src/resources/inflated_binary_grid.npy")

MAP_RESOLUTION = 1024
INFLATION_PIXELS = 25

def main():
    # --- AUTO-CREATE THE RESOURCES FOLDER IF IT IS MISSING ---
    output_dir = os.path.dirname(BINARY_GRID_PATH)
